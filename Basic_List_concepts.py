...
#names=["nasir","Python","Java","Django"]
...
#print(numbers)
#numbers.append(50)      # this function will add 50 at end in numbers
#print(numbers)
...
#**********************list eval function to access the middle value from the list**************************
#Python eval() is a built-in function that allows us to evaluate the Python expression as a 'string' and return the value as an integer.
# l=eval(input("Enter Your list : "))      #Accesing List middle value for accessing this list must be in odd
# print(l[len(l)//2])     #output: Enter Your list : [1,2,3]  2
